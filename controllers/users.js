            ...
            //console.log(hashedPassword);
              ...
              async(error,result)=>{
                ...
                if(result.length<=0){
                  ...
                  return res.render("index",{msg:"Password does not match :(  , If you have forgotten click Forgot password ,if none works write a mail to account@lavan.dev"});
                }
                else {
                   // console.log(result);
          ...
          //console.log(hashedPassword);
            ...
            async(error,result)=>{
              ...
              if(result.length<=0){
                ...
                return res.render("delete",{msg:"Password does not match :(  , If you have forgotten click Forgot password ,if none works write a mail to account@lavan.dev"});
              }
              else {
                 // console.log(result);
